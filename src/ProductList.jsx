								...
								{category.plants.map((plant, plantIndex) => (
									<div className="product-card" key={plantIndex}>
										...
										<button
											...
											disabled={Object.keys(addedToCart).includes(plant.name)}
											style={Object.keys(addedToCart).includes(plant.name) ? { backgroundColor: 'gray' } : {}}
										>
